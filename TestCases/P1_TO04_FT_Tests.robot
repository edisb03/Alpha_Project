...
P1_TO04_TC02 Footer TestBench Headline Links Verification
    [Documentation]    This Test case verifies and validates that  links are working properly without any errors
